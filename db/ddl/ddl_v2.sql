...
alter sequence gameversions_id_seq owner to cloudsqlsuperuser;
...
(
    ...
    user_id       integer not null
        constraint fk_user_settings_user_id__id
            references users
            on update restrict on delete restrict,
...
create table public_builds
(
    id        serial
        primary key,
    build     integer not null
        constraint fk_public_builds_build__id
            references pokemon_builds
            on update restrict on delete restrict,
...
create table terastal_map
(
    id         serial
        primary key,
    pokemon_id integer not null
        constraint fk_terastal_map_pokemon_id__id
            references grown_pokemons
            on update restrict on delete restrict,
    type       integer not null
        constraint fk_terastal_map_type__id
            references types
            on update restrict on delete restrict
);

alter table terastal_map
    owner to postgres;
...
(
    ...
    good_id integer not null
        constraint fk_good_details_good_id__id
            references goods
            on update restrict on delete restrict,
